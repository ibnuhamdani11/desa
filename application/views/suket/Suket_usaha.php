...
<!-- <div id="container"> -->
    ...
    <div id="body">
    	<p class="nama-surat">SURAT KETERANGAN USAHA</p>
    	<p class="nomor-surat">Nomor : 102/Ds.2008 /IV/2018</p>
        ...
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Benar bahwa Orang tersebut diatas  yang memiliki Usaha di bidang :</p>
        <p class="bidang">“ <?= $data_cetak->business?> ”</p>
    <!-- </div> -->
    	<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berhubung maksud yang bersangkutan, Kami mohon kepada pihak yang berwenang untuk memberikan bantuan seperlunya.</p>
